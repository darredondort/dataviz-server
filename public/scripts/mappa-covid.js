...
async function setup() {
  canvas = createCanvas(windowWidth, 540).parent('canvasContainer01');
  myMap = mappa.tileMap(options);
  myMap.overlay(canvas);

  data = loadJSON(await 'https://corona.lmao.ninja/countries', gotData);
...
function gotData(data) {
    loadJSON("../data/country-codes-lat-long-alpha3.json", gotCountries);
